Self-Checkout Systems Project Scope: Establishing a self-check (cashierless cashier) system with Raspberry pi, checking products with weight sensors and making payments with local payment integration.
